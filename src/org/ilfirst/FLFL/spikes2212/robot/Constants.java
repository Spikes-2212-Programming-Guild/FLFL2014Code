...
public class Constants {
	...
	// MAX_LEFT and MAX_RIGHT belong to the implementation which includes finding out the motors' real max speed manually.
	public static final double MAX_LEFT_VOLTAGE = 12;
	public static final double MAX_RIGHT_VOLTAGE = 12;
	// MAX_VOLTAGE belongs to the implementation which includes finding the motors' real max speed during runtime.
	...
	// limits the arms and the grabber to a certain voltage sent from the PDP
	// in order to save electricity for the other systems.
	public static final double VOLTAGE_LIMIT_GRABBER_USE = 9;
}
