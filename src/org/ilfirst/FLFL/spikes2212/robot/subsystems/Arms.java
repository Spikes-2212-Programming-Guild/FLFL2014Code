...
public class Arms extends Subsystem {
	...
	// return isOpenLimitSwitchExist() && isOpen();
	// }
	//
	// public boolean isAbleToClose() {
	// return isClosedLimitSwitchExist() && isClosed();
	// }
	//
	// public boolean isOpenLimitSwitchExist() {
	// return SmartDashboard.getBoolean("openLimitExist", false);
	// }
	//
	// public boolean isClosedLimitSwitchExist() {
	// return SmartDashboard.getBoolean("closedLimitExist", false);
	// }
	//
}
